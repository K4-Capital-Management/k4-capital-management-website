            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Cole McNally is an Investment Associate at K4 Capital Management, where he focuses on investment analysis, deal sourcing, and portfolio monitoring across the firm's real estate and venture capital investments. He supports transaction execution in structured equity and early-stage venture opportunities through financial modeling and due diligence.
                </p>
